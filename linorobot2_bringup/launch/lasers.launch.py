...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node( 
            ...
            parameters=[{
                'port': '/dev/ttyUSB1',
                # 'baud_rate': 115200, TODO: Fix param issue, now hardcode in driver first
                'frame_id': LaunchConfiguration('frame_id'),
                # 'firmware_version': 2, TODO: Fix param issue, now hardcode in driver first
            }],
        ),
